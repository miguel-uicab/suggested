...
def prediction(json=None,
    ...
    if with_fid_grid_variables:
        ...
        for name in config_pred['list_names_in_polygons_to_group_rare_identifiers']:
            list_not_used = pickle.load(open(f'{path}/{name}s_not_used.sav', 'rb'))
        ...
        grid_data_complete = pickle.load(open(f'{path}/grid_data_complete.sav',
                                              'rb'))
        cadastral_data_fid = pickle.load(open(f'{path}/cadastral_data_fid.sav',
                                              'rb'))
    ...
    colonias_df = pickle.load(open(f'{path}/colonias_df.sav', 'rb'))
    ...
    encoder_cdmx = pickle.load(open(f'{path}/encoder_cdmx.sav', 'rb'))
    ...
    # Predicción. #############################################################
    model = pickle.load(open(f'{path}/model_cdmx.sav',
                             'rb'))
